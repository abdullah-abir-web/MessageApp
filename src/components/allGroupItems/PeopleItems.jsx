...
function PeopleItems() {
  ...
  return (
    <div className="w-1/3 p-4 rounded-2xl bg-[#222831] shadow-lg">
      <div className="flex justify-between pb-4">
        <h2 className="title font-secondary text-white  text-2xl font-semibold">People</h2>
      </div>
      <div className=" py-2 px-3 border-2 border-black rounded-lg w-full flex items-center gap-2">
